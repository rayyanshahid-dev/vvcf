/* Header automatically generated at 2026-07-29T08:19:35.061 */
/* Clinical data taken from https://www.clinpgx.org/page/cyp2c19RefMaterials */

#ifndef CYP2C19_CDS_LUT_H
#define CYP2C19_CDS_LUT_H

static const char * const cyp2c19_phenotype_names[] = {"CYP2C19 Indeterminate", "CYP2C19 Intermediate Metabolizer", "CYP2C19 Likely Intermediate Metabolizer", "CYP2C19 Likely Poor Metabolizer", "CYP2C19 Normal Metabolizer", "CYP2C19 Poor Metabolizer", "CYP2C19 Rapid Metabolizer", "CYP2C19 Ultrarapid Metabolizer",};

/* note: removed extra "Abnormal/Priority/High Risk" strings as there are only 3 possible values for this column, so no need to keep the extra */
static const char * const cyp2c19_ehr_notation[] = {"none", "Abnormal/Priority/High Risk", "Normal/Routine/Low Risk",};
...
static const int cyp2c19_consultation_text_idx[] = {1, 2, 3, 4, 5, 6, 7, 8};
